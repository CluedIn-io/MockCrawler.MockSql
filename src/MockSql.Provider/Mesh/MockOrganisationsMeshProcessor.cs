...
{
  public class MockOrganisations_Command_MeshProcessor : BaseMeshProcessor
  {
    public MockOrganisations_Command_MeshProcessor(ApplicationContext appContext)
        : base(appContext)
    {
    }

    public override Guid GetProviderId() =>
      MockOrganisationsConstants.ProviderId;
