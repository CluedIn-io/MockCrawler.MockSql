...
{
    public class DataIngestion : IClassFixture<MockOrganisationsTestFixture>
    {
        private readonly MockOrganisationsTestFixture _fixture;
        private readonly ITestOutputHelper _output;

        public DataIngestion(MockOrganisationsTestFixture fixture, ITestOutputHelper output)
        {
            _fixture = fixture;
            _output = output;
