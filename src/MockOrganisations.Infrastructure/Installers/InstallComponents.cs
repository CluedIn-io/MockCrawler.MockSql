...
namespace CluedIn.Crawling.MockOrganisations.Infrastructure.Installers
{
  public class InstallComponents : IWindsorInstaller
  {
    public void Install(IWindsorContainer container, IConfigurationStore store)
    {
      container
          ...
          .Register(Component.For<IMockOrganisationsClientFactory>().AsFactory())
          .Register(Component.For<MockOrganisationsClient>().LifestyleTransient());
